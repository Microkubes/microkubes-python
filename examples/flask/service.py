...
app = Flask(__name__)
registrator = KongGatewayRegistrator(os.environ.get(
    "API_GATEWAY_URL", "http://localhost:8000"))  # Use the Kong registrator for Microkubes
...
registrator.register(name="hello-service",                  # the service name.
                     # URL pattern that Kong will use to redirect requests to out service
                     paths=["/"],
                     # The hostname of the service.
                     host="hello-service.service.consul",
